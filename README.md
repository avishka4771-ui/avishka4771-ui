<h1 align="center">Avishka Dodangoda</h1>

<p align="center">
  <strong>Electronics & Telecommunication Engineering Undergraduate</strong><br>
  Embedded Systems · Digital Design · Robotics
</p>
...
Built and tested an ESP32-based wearable prototype that estimates an approximate acoustic direction across eight compass sectors and displays the result on an OLED.
...
| --- | --- |
| Programming | C, C++ |
| Embedded platforms | ESP32, ESP8266, Arduino Mega |
| Communication and control | I²C, I²S, UART, GPIO, PWM |
| Hardware and sensors | PCB design, INMP441 microphones, ultrasonic and ToF sensors, colour sensors, servos, DC motors, WS2812B LEDs |
| Development tools | PlatformIO, Visual Studio Code, Arduino IDE, Proteus, MATLAB, Wokwi |

### Engineering exposure

- PCB assembly, soldering, ESD control, inspection, and electronic testing.
- Data-centre infrastructure, networking, backup power, and environmental control.
- Fibre-optic and submarine-cable communication systems, including DWDM concepts.

### Leadership and involvement

- Marketing Supervisor and Director of Marketing, IET on Campus.
...
<p align="center"><em>Build. Test. Measure. Document.</em></p>
